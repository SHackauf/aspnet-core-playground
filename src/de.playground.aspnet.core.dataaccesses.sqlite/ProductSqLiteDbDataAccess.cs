...
{
    public class ProductSqLiteDbDataAccess : EntityDataAccessBase<ProductPoco, SqLiteDbContext>, IProductDataAccess
    {
        #region Constructor

        public ProductSqLiteDbDataAccess(ILogger<ProductSqLiteDbDataAccess> logger, SqLiteDbContext sqLiteDbContext)
        ...
        protected override DbSet<ProductPoco> GetDbSet(SqLiteDbContext dbContext) => dbContext.Products;
